...
// document.getElementById("lnkPrevVMonth").style.display= document.getElementById("lnkPrevMonth").style.display;

// document.getElementById("lnkNextVMonth").style.display= document.getElementById("lnkNextMonth").style.display;
...
selection_right=$$("#selection").offset().left + $$("#selection").outerWidth()
selection_bottom=$$("#selection").offset().top + $$("#selection").height()
added_margin=window_right-selection_right;
added_margin2=window_bottom-selection_bottom;
